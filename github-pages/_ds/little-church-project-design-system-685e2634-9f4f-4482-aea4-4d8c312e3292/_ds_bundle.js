/* @ds-bundle: {"format":4,"namespace":"LittleChurchProjectDesignSystem_685e26","components":[{"name":"SectionHeading","sourcePath":"components/brand/SectionHeading.jsx"},{"name":"VerseBlock","sourcePath":"components/brand/VerseBlock.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Icon","sourcePath":"components/core/Icon.jsx"},{"name":"IconButton","sourcePath":"components/core/IconButton.jsx"},{"name":"Tag","sourcePath":"components/core/Tag.jsx"},{"name":"Dialog","sourcePath":"components/feedback/Dialog.jsx"},{"name":"Toast","sourcePath":"components/feedback/Toast.jsx"},{"name":"Tooltip","sourcePath":"components/feedback/Tooltip.jsx"},{"name":"Checkbox","sourcePath":"components/forms/Checkbox.jsx"},{"name":"Field","sourcePath":"components/forms/Field.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Radio","sourcePath":"components/forms/Radio.jsx"},{"name":"Select","sourcePath":"components/forms/Select.jsx"},{"name":"Switch","sourcePath":"components/forms/Switch.jsx"},{"name":"Textarea","sourcePath":"components/forms/Textarea.jsx"},{"name":"Tabs","sourcePath":"components/navigation/Tabs.jsx"}],"sourceHashes":{"components/brand/SectionHeading.jsx":"ba4afbdeba8d","components/brand/VerseBlock.jsx":"bcd7fd89c2f4","components/core/Badge.jsx":"cf85bec3f94d","components/core/Button.jsx":"16116da2015e","components/core/Card.jsx":"32f3e36c8fc2","components/core/Icon.jsx":"11fe84ec62d2","components/core/IconButton.jsx":"05322a8f527c","components/core/Tag.jsx":"efe3d083c638","components/feedback/Dialog.jsx":"2a617ac1bb1d","components/feedback/Toast.jsx":"ca3cf0b2faed","components/feedback/Tooltip.jsx":"2af4f3c60b61","components/forms/Checkbox.jsx":"bf753a7344ef","components/forms/Field.jsx":"4b06d8422497","components/forms/Input.jsx":"0a71425ff4d3","components/forms/Radio.jsx":"671984681409","components/forms/Select.jsx":"ee4079239428","components/forms/Switch.jsx":"6d6545a2c9fd","components/forms/Textarea.jsx":"c3ff6658392b","components/navigation/Tabs.jsx":"6dbaa09ecc27","skills/family-worship-sheet/reference/doc-page.js":"f52ae9c02fca"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.LittleChurchProjectDesignSystem_685e26 = window.LittleChurchProjectDesignSystem_685e26 || {});
...
function SectionHeading({
  ...
  return React.createElement('header', {
    style: {
      textAlign: align,
      maxWidth: align === 'center' ? 'var(--measure-prose)' : 'none',
  ...
  }, eyebrow) : null, React.createElement('h' + level, {
    style: {
      margin: 0,
      fontFamily: 'var(--font-body)',
      fontWeight: 'var(--fw-bold)',
...
// components/brand/VerseBlock.jsx
try { (() => {
function VerseBlock({
  reference,
  children,
  ...
  const bg = tone === 'soft' ? 'var(--surface-highlight)' : tone === 'olive' ? 'var(--surface-accent-soft)' : 'transparent';
  return React.createElement('figure', {
    style: {
      margin: 0,
      padding: tone === 'paper' ? '0 0 0 var(--space-5)' : 'var(--space-6)',
      borderLeft: tone === 'paper' ? '2px solid var(--line-brand)' : 'none',
      borderRadius: tone === 'paper' ? 0 : 'var(--radius-3)',
      background: bg,
      textAlign: align,
      ...style
    },
  ...
  }, children), reference ? React.createElement('figcaption', {
    style: {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/brand/VerseBlock.jsx", error: String((e && e.message) || e) }); }
...
function Card({
  ...
  const [hover, setHover] = React.useState(false);
  const shadows = ['var(--shadow-0)', 'var(--shadow-1)', 'var(--shadow-2)', 'var(--shadow-3)'];
  return React.createElement('div', {
    ...
    style: {
      ...
      letterSpacing: 'var(--ls-eyebrow)',
      textTransform: 'uppercase',
      color: tone === 'inverse' ? 'var(--brick-200)' : 'var(--text-brand)',
    ...
    style: {
      ...
      lineHeight: 'var(--lh-title)',
      letterSpacing: 'var(--ls-title)',
      color: tone === 'inverse' ? 'var(--text-on-inverse)' : 'var(--text-title)'
    }
...
try { (() => {
/* Lucide (CDN) is the brand's icon set — 1.75px stroke, round caps.
   Pages must load https://unpkg.com/lucide@0.470.0/dist/umd/lucide.js once. */
function Icon({
  name,
  size = 20,
  strokeWidth = 1.75,
  ...
  React.useEffect(() => {
    ...
    if (!node || !lib || !lib.createElement) {
      /* missing glyph: show a hairline placeholder box rather than nothing */
      el.innerHTML = '';
      const box = document.createElement('span');
      box.style.cssText = 'width:100%;height:100%;border:1px dashed var(--line-soft);border-radius:2px';
      el.appendChild(box);
      return;
    }
    el.innerHTML = '';
...
function IconButton({
  ...
  return React.createElement('button', {
    ...
    style: {
      ...
      ...tone,
      ...(hover && !disabled ? {
        background: variant === 'solid' ? 'var(--brick-600)' : 'var(--surface-sunken)',
        color: variant === 'solid' ? 'var(--text-on-brand)' : 'var(--text-body)'
      } : null),
      ...(disabled ? {
        opacity: .4
      } : null),
...
function Tag({
  ...
  return React.createElement('span', {
    ...
    style: {
      ...
      transition: 'var(--transition-base)',
      background: selected ? 'var(--surface-brand)' : hover && onClick ? 'var(--brick-100)' : 'var(--surface-card)',
      color: selected ? 'var(--text-on-brand)' : 'var(--text-body)',
      borderColor: selected ? 'transparent' : 'var(--line-soft)',
      ...style
    },
    ...rest
...
function Checkbox({
  ...
  return React.createElement('label', {
    ...
    style: {
      ...
      justifyContent: 'center',
      transition: 'var(--transition-base)',
      background: checked ? 'var(--surface-brand)' : 'var(--surface-raised)',
      borderColor: checked ? 'transparent' : 'var(--line-strong)',
      color: 'var(--text-on-brand)',
      fontSize: 12,
      lineHeight: 1
    }
...
function Input({
  ...
  const field = React.createElement('input', {
    ...
    style: {
      ...inputShellStyle,
      padding: iconLeft ? '11px 14px 11px 38px' : pad,
      fontSize: size === 'sm' ? 'var(--fs-body-sm)' : 'var(--fs-body)',
      borderColor: invalid ? 'var(--status-danger)' : focus ? 'var(--line-focus)' : 'var(--line-soft)',
...
function Radio({
  ...
  return React.createElement('label', {
    ...
    style: {
      ...
      justifyContent: 'center',
      transition: 'var(--transition-base)',
      borderColor: checked ? 'var(--brick-500)' : 'var(--line-strong)',
      background: 'var(--surface-raised)'
    }
  }, React.createElement('span', {
    style: {
      ...
      height: 10,
      borderRadius: 'var(--radius-pill)',
      background: checked ? 'var(--surface-brand)' : 'transparent',
      transition: 'var(--transition-base)'
    }
...
function Switch({
  ...
  return React.createElement('label', {
    ...
    style: {
      ...
      padding: 3,
      borderRadius: 'var(--radius-pill)',
      background: checked ? 'var(--surface-brand)' : 'var(--paper-3)',
      transition: 'var(--transition-base)',
      display: 'inline-flex',
      alignItems: 'center'
    }
  ...
  return React.createElement('div', {
    ...
    return React.createElement('button', {
      ...
      style: {
        ...
        borderBottom: '2px solid ' + (active ? 'var(--brick-500)' : 'transparent'),
        transition: 'var(--transition-base)',
        display: 'inline-flex',
        alignItems: 'center',
        gap: 'var(--space-2)'
...
// skills/family-worship-sheet/reference/doc-page.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "skills/family-worship-sheet/reference/doc-page.js", error: String((e && e.message) || e) }); }
